    ...
    <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i}>
                ...
                <div className="font-display text-5xl lg:text-6xl text-cream-50 mb-2 leading-none" style={{ fontVariationSettings: "'opsz' 144" }}>{s.num}</div>
      ...
      <Section title="Single statement stat" description="For a featured number on a hero or section header. Maximum drama, minimum elements.">
        <div className="bg-cream-100 border border-cream-300 rounded-2xl p-12 text-center">
          <div className="font-display text-[clamp(80px,20vw,200px)] leading-[0.85] text-navy-900" style={{ fontVariationSettings: "'opsz' 144, 'wght' 400, 'WONK' 1" }}>11,708</div>
